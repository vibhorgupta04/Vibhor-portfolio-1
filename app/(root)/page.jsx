              ...
              <div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
                ...
                >
                  ...
                  >
                    ...
                    such as React JS, Node JS, Express JS, and Next JS. My
                    experience spans full-stack web development, frontend
                    development, responsive UI, API development, backend schema
                    creation, and API integrations. I excel in crafting complex
                    logic and delivering highquality, scalable solutions to meet
                    diverse project requirements. My strong technical skills,
                    combined with a passion for continuous learning and
                    problem-solving enable me to contribute effectively to any
                    development team.
                  </motion.p>
                  <motion.div
              ...
              <div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
                ...
                <div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
                  ...
                  <div className="flex justify-center items-center space-x-4">
                    ...
                    <motion.a
                      href="https://github.com/vibhorgupta04"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
                    ...
                    <motion.a
                      href="https://www.instagram.com/vibhorgupta04"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
                      initial={{ opacity: 0, y: 40 }}
                    ...
                    <motion.a
                      href="https://www.linkedin.com/in/vibhor-dev/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
                      initial={{ opacity: 0, y: 40 }}
