        ...
        <div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
          ...
          >
            ...
            <p className="text-gray-600 text-justify title text-lg">
              Hey there, I&rsquo;m Vibhor Gupta, a
              <strong> tech enthusiast</strong> and
              <strong> aspiring Web Developer.</strong> Originating from Delhi,
              India. My passion for technology and coding knows no bounds. I
              specialize in{" "}
              <strong>React, Next.js, Node.js, Express.js and MongoDB</strong>.
              I am proficient in JavaScript and TypeScript, enabling robust,
              maintainable codebases. Beyond the world of coding, I believe that
              in today&rsquo;s fast-paced digital landscape, being a
              <strong> lifelong learner</strong> is not just a choice, but a
              necessity. Let&rsquo;s connect and explore this ever-evolving
              world of tech together!
            </p>
            <Card />
          </motion.div>
        </div>
