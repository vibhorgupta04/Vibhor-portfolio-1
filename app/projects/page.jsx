        ...
        <div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
          ...
          >
            ...
            <p className="text-gray-600 text-justify title text-lg">
              Developed a robust cryptocurrency dashboard application using
              React, enabling users to track and analyze cryptocurrency data.
              Implemented realtime search functionality for intuitive discovery
              of specific cryptocurrencies, and allowed users to switch between
              different currencies for flexible viewing of prices and
              statistics. Integrated Chart.js to provide customizable and
              interactive charts for in-depth analysis of cryptocurrency trends
              and comparisons. Additionally, created a section to highlight
              trending coins, offering insights into current market dynamics.
            </p>{" "}
            <div className="mt-3">
              <Button variation="primary">
                <Link href="projects/crypto">More</Link>
              </Button>
              <Button variation="secondary">
                <a
                  href="https://crypto-currency-dasshboard.vercel.app/"
                  target="_blank"
